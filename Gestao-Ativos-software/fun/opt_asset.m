...
problem.costReductionRate = 0.0; % 0 - for all asset except for bridge, where this value indicates reduction of cost when actions are applied for all components
problem.numberOfSamples = 30;
...
asset.costReductionRate = 0.0; % 0 - for all asset except bridge; 
...
fprintf(fid, '%s %.2f \n', 'cost_reduction_rate', asset.costReductionRate);
