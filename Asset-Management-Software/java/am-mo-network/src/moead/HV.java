...
// the vesion below, unexpectedly works slower !!!
...
//        double [][] dim3_param6;
//    
//    public void initialize(int dim, int size)
//    {
//        switch(dim)
//        {
//            case 2:
//                dim2_param1 = new double[size];
//                dim2_param2 = new int[size];;
//                break;
//            case 3:
//                dim3_param1 = new double[size+1];
//                dim3_param2 = new double[size+1];
//                
//                dim3_param3 = new int[size+1];
//                dim3_param4 = new int[size+1];
//                
//                dim3_param5 = new double[size][size];
//                dim3_param6 = new double[size][size];
//                break;
//        }
//    }
//    
...
//        int i, j, k;
//        
//        double [] a = dim3_param1;
//        double [] b = dim3_param2;
//        
//        int [] idx_a = dim3_param3;
//        int [] idx_b = dim3_param4;
//        
//        double [][] best1_f3 = dim3_param5;
//        double [][] best2_f3 = dim3_param6;
//        
//        for(i = 0; i < size; i++)
//        {
//            s[i] = 0.0; // init S metric
